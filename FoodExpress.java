class FoodExpress {
     ...
     public static double foodExpressFood(String foodName){
        ...
        else if(foodName == "Chicken Steamed Momos")
	...
	public static double foodExpressFood(String foodName, int quantity){
		...
		{ price = 25.00d*quantity; return price; }
        else if(foodName == "Garlic Naan")
		...
		{ price = 70.00d*quantity; return price; }
        else if(foodName == "Mint Mojito")
