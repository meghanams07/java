class GrubHub {
    ...
    public static double grubHubFood(String foodName){

        double price = 0.0d;

        if(foodName == "Cheese Burst Pizza")
		{ price = 275.00d; return price; }
        else if(foodName == "Farm Fresh Pizza")
		{ price = 295.00d; return price; }
        else if(foodName == "Paneer Tikka Pizza")
		{ price = 310.00d; return price; }
        else if(foodName == "BBQ Chicken Pizza")
		{ price = 330.00d; return price; }
        else if(foodName == "Veggie Delight Burger")
		...
		{ price = 380.00d; return price; }
        else if(foodName == "Garlic Naan")
		{ price = 45.00d; return price; }
        else if(foodName == "Butter Roti")
		{ price = 30.00d; return price; }
		...
		{ price = 110.00d; return price; }
        else if(foodName == "Lemon Soda")
		{ price = 60.00d; return price; }
        else if(foodName == "Mint Mojito")
		...
		{ price = 105.00d; return price; }
        else if(foodName == "Brownie")
		{ price = 140.00d; return price; }
        else if(foodName == "Ice Cream Sundae")
		{ price = 160.00d; return price; }
        else if(foodName == "Cheesecake Slice")
		{ price = 190.00d; return price; }
		...
		{ price = 280.00d; return price; }
        else if(foodName == "Family Pizza Combo")
		{ price = 620.00d; return price; }
        else if(foodName == "Mega Burger Combo")
		{ price = 390.00d; return price; }
        else if(foodName == "Party Snack Box")
		{ price = 450.00d; return price; }
        else if(foodName == "Veg Platter")
		{ price = 350.00d; return price; }
	...
	public static double grubHubFood(String foodName, int quantity){

        double price = 0.0d;

        if(foodName == "Cheese Burst Pizza")
		{ price = 275.00d*quantity; return price; }
        else if(foodName == "Farm Fresh Pizza")
		{ price = 295.00d*quantity; return price; }
        else if(foodName == "Paneer Tikka Pizza")
		{ price = 310.00d*quantity; return price; }
        else if(foodName == "BBQ Chicken Pizza")
		{ price = 330.00d*quantity; return price; }
        else if(foodName == "Veggie Delight Burger")
		...
		{ price = 380.00d*quantity; return price; }
        else if(foodName == "Garlic Naan")
		{ price = 45.00d*quantity; return price; }
        else if(foodName == "Butter Roti")
		{ price = 30.00d*quantity; return price; }
        else if(foodName == "Chilli Paneer")
		...
		{ price = 60.00d*quantity; return price; }
        else if(foodName == "Mint Mojito")
		...
		{ price = 105.00d*quantity; return price; }
        else if(foodName == "Brownie")
		{ price = 140.00d*quantity; return price; }
        else if(foodName == "Ice Cream Sundae")
		{ price = 160.00d*quantity; return price; }
		...
		{ price = 280.00d*quantity; return price; }
        else if(foodName == "Family Pizza Combo")
		{ price = 620.00d*quantity; return price; }
        else if(foodName == "Mega Burger Combo")
		{ price = 390.00d*quantity; return price; }
        else if(foodName == "Party Snack Box")
		{ price = 450.00d*quantity; return price; }
        else if(foodName == "Veg Platter")
		{ price = 350.00d*quantity; return price; }
        else if(foodName == "Chicken Platter")
